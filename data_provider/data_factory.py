from data_provider.data_loader import UnivariateDatasetBenchmark, MultivariateDatasetBenchmark, Global_Temp, Global_Wind, Dataset_ERA5_Pretrain, Dataset_ERA5_Pretrain_Test, UTSD, UTSD_Npy, NegotiationDataset
...
data_dict = {
    ...
    'Utsd': UTSD,
    'Utsd_Npy': UTSD_Npy,
    'Negotiation': NegotiationDataset,
}
